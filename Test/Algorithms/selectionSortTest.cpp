...
#include "../../Algorithms/Sort/Selection/cpp/selectionSort.h"
...
{   
    ...
    selectionSortIntegers(dataset1, 11, 1);
...
{   
    ...
    selectionSortIntegers(dataset2, 8, 1);
...
{   
    ...
    selectionSortIntegers(dataset3, 11, 1);
