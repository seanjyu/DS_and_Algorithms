...
#include "../../Algorithms/Sort/Insertion/cpp/insertSort.h"
...
{   
    ...
    insertionSortIntegers(dataset1, 11, 1);
...
{   
    ...
    insertionSortIntegers(dataset2, 3, 1);


    if (arrays_equal(dataset2, solution, 3))
    {
        passed = 1;
    }
...
{   
    ...
    insertionSortIntegers(dataset3, 11, 1);
